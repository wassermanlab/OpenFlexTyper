...
//======================================================================
std::set<std::string> KmerGenerator::genSlidingSearchStrings(const std::string& queryString, uint kmerSize, uint stride, bool kmerCounts)
{
...
//======================================================================
std::set<std::string> KmerGenerator::genCenteredSearchStrings(const std::string& queryString, uint kmerSize, uint overlap, uint stride, bool kmerCounts)
{
    std::set<std::string> searchStrings;
...
//======================================================================
SearchKmers KmerGenerator::genSearchKmers(std::set<Query> inputQueries, uint kmerSize, bool refOnly, SearchType searchType, uint overlap,  uint stride, bool kmerCounts)
{
    SearchKmers results;
    for (auto inputQuery : inputQueries) {
        ...
        if (searchType == CENTERED) {
            refSearchStrings = genCenteredSearchStrings(refQueryString, kmerSize, overlap, stride, kmerCounts);
        } else {
            refSearchStrings = genSlidingSearchStrings(refQueryString, kmerSize, stride, kmerCounts);
        }
        ...
        if (!refOnly) {
            ...
            if (searchType == CENTERED) {
                altSearchStrings = genCenteredSearchStrings(altQueryString, kmerSize, overlap, stride, kmerCounts);
            } else {
                altSearchStrings = genSlidingSearchStrings(altQueryString, kmerSize, stride, kmerCounts);
            }
...
//======================================================================
SearchKmers KmerGenerator::genQueryKmers(Query inputQuery, uint kmerSize, bool refOnly, SearchType searchType, uint overlap, uint stride, bool crossover, bool kmerCounts)
{
    SearchKmers results;
    ...
    */
    ...
    if (!refOnly) {
        ...
        if (crossover && !refSearchStrings.empty() && !altSearchStrings.empty()) {
            ...
            if (searchType == CENTERED) {
                crossoverStrings = genCenteredSearchStrings(crossoverQueryString, kmerSize, overlap, stride, kmerCounts);
            } else {
...
void KmerGenerator::genKmerMap(std::set<Query>& inputQueries, uint kmerSize, bool refOnly, const SearchType& searchType, KmerMap& kmerMap, uint overlap, uint stride,
                               bool crossover, bool ignoreNonUniqueKmers, bool kmerCounts)
{
    for (auto query : inputQueries) {
        SearchKmers query_kmers = genQueryKmers(query, kmerSize, refOnly, searchType, overlap, stride, crossover, kmerCounts);
