...
public:
    ...
    MOCK_METHOD8(search,               std::tuple<ft::ResultsFuture, std::set<std::pair<int, ft::QueryType>>>(const std::string&, const std::set<std::pair<int, ft::QueryType>>&, const std::string&, const std::string&, u_int, size_t, bool, bool));
